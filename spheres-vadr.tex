  ...
  \item A general tool for reference-based annotation of virus sequences
    \begin{itemize}
      \item aligns sequences globally with respect to a RefSeq or
        profile
      \item originally tested for Dengue and Norovirus
      \item used for SARS-CoV-2 since March 2020, automatically since June
        2020
    \end{itemize}
\end{itemize}
...
\begin{slide}
\begin{center}
\Large{\textbf{Each sequence PASSes or FAILs}}
\end{center}

\begin{itemize}
\item Sequences with 1 or more fatal 'alerts' FAIL and are examined by
  submitter and/or GenBank indexer
\item Sequences with 0 fatal 'alerts' PASS and are automatically
  deposited into GenBank
\item TODO: simple diagram showing two possible outcomes and listing
  some fatal alerts (early stop, nonhomologous region, etc.)
\end{itemize}
...
\begin{itemize}
\item TODO: make some type of table indicating why sequences fail
  SARS-CoV-2 (easiest would be for GOOD seqs that eventually went into
  GenBank, or could get feedback from Linda about BAD seqs that never
  went into GenBank)
\end{itemize}
